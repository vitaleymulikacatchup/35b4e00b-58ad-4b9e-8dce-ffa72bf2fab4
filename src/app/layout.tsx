...
const playfairDisplay = Playfair_Display({ variable: "--font-playfair", subsets: ["latin"], weight: ["400", "500", "600", "700", "800", "900"] });
...
const nunito = Nunito({ variable: "--font-nunito", subsets: ["latin"], weight: ["200", "300", "400", "500", "600", "700", "800", "900"] });

export const metadata: Metadata = {
  title: "ITCompany - Innovative IT Solutions",
  description: "Explore top-notch IT services that transform your business!",
  openGraph: {
    title: "ITCompany - Innovative IT Solutions",
    description: "Explore top-notch IT services that transform your business!",
    siteName: "ITCompany",
    images: [{ url: "https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website"
  },
  twitter: {
    ...
    title: "ITCompany - Innovative IT Solutions",
    description: "Explore top-notch IT services that transform your business!",
    images: ["https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
